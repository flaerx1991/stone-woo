...
class Admin extends Base_App {
	...
	protected function init_actions() {
		...
		add_action( 'cmsmasters_import_ready', function() {
			update_option( 'cmsmasters_import_rewrite_widgets_external_media_url', 'pending' );
		}, 11 );

		add_action( 'admin_init', function() {
			if ( 'pending' !== get_option( 'cmsmasters_import_rewrite_widgets_external_media_url' ) ) {
				return;
			}
			...
			update_option( 'cmsmasters_import_rewrite_widgets_external_media_url', 'done' );
		}, 20 );
	}
