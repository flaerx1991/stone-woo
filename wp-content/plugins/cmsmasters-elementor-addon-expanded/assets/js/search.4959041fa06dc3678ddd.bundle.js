...
class Search extends _handler.default {
  ...
  bindEvents() {
    ...
    this.elements.$popupSearchButton.on('click', this.onButtonClick.bind(this));
    this.elements.$popupCloseButton.on('click', this.onButtonCloseClick.bind(this));
    this.elements.$popupContainer.on('click', this.onContainerClick.bind(this));
  }
  onInit() {
    super.onInit();
    this.onEdit();
...
//# sourceMappingURL=search.4959041fa06dc3678ddd.bundle.js.map