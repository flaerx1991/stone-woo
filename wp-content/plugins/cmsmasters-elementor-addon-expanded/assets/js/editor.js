...
/***/ "../modules/instagram/assets/dev/js/editor/editor.js":
/*!***********************************************************!*\
  !*** ../modules/instagram/assets/dev/js/editor/editor.js ***!
  \***********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = EditorModule.extend({
  onElementorPreviewLoaded: function onElementorPreviewLoaded() {
    elementor.channels.editor.on('cmsmasters:instagram:remove_cache', this.onRemoveCache.bind(this));
  },
  onRemoveCache: function onRemoveCache(control) {
    var $button = control.$el.find('button');
    var $icon = jQuery('<i/>', {
    ...
    var options = {
      complete: function complete() {
        elementor.notifications.showToast({
          message: cmsmastersElementor.translate('cache_deleted')
        });
        $icon.remove();
      }
    };
    $button.prepend($icon);
    cmsmastersElementor.ajax.addRequest('instagram_remove_cache', options);
  }
});
...
module.exports = FooterSaverBehavior.extend({
  initialize: function initialize() {
    ...
    var locationDocuments = ['cmsmasters_header', 'cmsmasters_footer', 'cmsmasters_singular', 'cmsmasters_archive', 'cmsmasters_product_singular', 'cmsmasters_product_archive'];
...
var CmsmastersElementor = Marionette.Application.extend({
  ...
  moduleHandlers: {
    ...
    Instagram: __webpack_require__(/*! cmsmasters-modules/instagram/assets/dev/js/editor/editor */ "../modules/instagram/assets/dev/js/editor/editor.js"),
