...
class Products extends Base_Products {
	...
	public function render_ajax( $ajax_vars = array() ) {
		...
		// 	$_GET['orderby'] = $attributes['orderby'];
		// }
	...
	public function render_header_layout() {
		...
		if ( $layout_label ) {
			...
			echo '<span class="cmsmasters-woo-products__header-layout-columns">' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-1" aria-label="One column" data-layout="1"></span>' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-2" aria-label="Two column" data-layout="2"></span>' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-3" aria-label="Three column" data-layout="3"></span>' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-4" aria-label="Four column" data-layout="4"></span>' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-5" aria-label="Four column" data-layout="5"></span>' .
				'<span class="cmsmasters-woo-products__header-layout-column cmsicon-column-6" aria-label="Four column" data-layout="6"></span>' .
			'</span>' .
		'</div>';
	}
