...
class Product_Add_To_Cart extends Base_Widget {
	...
	protected function register_atc_button_controls_style() {
		...
		$this->add_group_control(
			...
			array(
				'name' => 'button_bg_color_group',
				'exclude' => array( 'color' ),
				'selector' => $this->product_base . 'form.cart .button:before',
			)
		);

		$this->start_injection( array( 'of' => 'button_bg_color_group_background' ) );
		...
		$this->add_group_control(
			CmsmastersControls::BUTTON_BACKGROUND_GROUP,
			array(
				'name' => 'button_bg_color_group_hover',
				'exclude' => array( 'color' ),
				'selector' => $this->product_base . 'form.cart .button:after',
			)
		);

		$this->start_injection( array( 'of' => 'button_bg_color_group_hover_background' ) );
	...
	protected function register_atc_quantity_controls_style() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors' => array(
					$this->product_base . '.quantity + .button' => 'margin-left: {{SIZE}}{{UNIT}}',
				),
			)
		);
	...
	protected function register_atc_variations_controls_style() {
		...
		$this->start_controls_tabs( 'variations_reset' );
	...
	protected function register_wpcvs_atc_variation_section_style() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					$selector => '--cmsmasters-variations-reset-alignment: {{VALUE}}',
				),
			)
		);
