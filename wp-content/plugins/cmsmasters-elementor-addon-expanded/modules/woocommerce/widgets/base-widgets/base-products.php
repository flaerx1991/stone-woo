...
abstract class Base_Products extends Base_Widget {
	...
	protected function render_products_before() {
		$this->add_render_attribute( 'products_wrapper', 'class', 'elementor-widget-cmsmasters-woo-products-inner' );

		echo '<div ' . $this->get_render_attribute_string( 'products_wrapper' ) . '>';
