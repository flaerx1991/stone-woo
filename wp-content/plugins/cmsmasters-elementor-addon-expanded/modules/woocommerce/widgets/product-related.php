...
class Product_Related extends Base_Products {
	...
	public function render_products() {
		...
		$order = Utils::get_if_not_empty( $settings, 'order', 'desc' );
		$orderby = Utils::get_if_not_empty( $settings, 'orderby', 'rand' );
		$posts_per_page = Utils::get_if_not_empty( $settings, 'posts_per_page', 8 );
