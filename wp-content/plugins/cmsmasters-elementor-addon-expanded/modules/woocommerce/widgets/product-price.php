...
class Product_Price extends Base_Widget {
	...
	protected function render() {
		...
		$prefix_label = isset( $settings['prefix_label'] ) ? $settings['prefix_label'] : 'Price:';

		echo "<div class=\"elementor-widget-cmsmasters-woo-product-price__wrap cmsmasters-product-{$type}\">";

		if ( 'none' !== $prefix_style ) {
			if ( 'text' === $prefix_style ) {
				echo '<div class="elementor-widget-cmsmasters-woo-product-price__prefix">' . $prefix_label . '</div>';
			} elseif ( 'icon' === $prefix_style ) {
				echo '<div class="elementor-widget-cmsmasters-woo-product-price__prefix">' . $this->render_icon( $settings ) . '</div>';
			}
		}
