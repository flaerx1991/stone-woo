...
class Wpclever_Smart_Wishlist_Button extends Wpclever_Smart_Button_Base {
	...
	public function wishlist_button_html( $output, $woosw)  {
		...
		$is_button = $settings['wpclever_items_type'] === 'button';
		$is_link = $settings['wpclever_items_type'] === 'link';
		$is_icon = $settings['wpclever_items_type'] === 'icon';
