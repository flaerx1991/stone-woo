...
class Module extends Base_Module {
	...
	public function register_ajax_widget_handlers( AjaxWidgetModule $ajax_widget ) {
		$ajax_widget->add_handler( 'cmsmasters-woo-archive-products', array( $this, 'render_ajax_widget' ) );
		$ajax_widget->add_handler( 'cmsmasters-woo-products', array( $this, 'render_ajax_widget' ) );
	}
