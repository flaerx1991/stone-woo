...
class Pagination {
	...
	public function render() {
		...
		echo paginate_links( $this->get_pagination_args() );
	}
	...
	protected function get_html_arrows( $settings_name ) {
		...
		$html .= Utils::get_render_icon( $icon_setting, array( 'aria-hidden' => 'true' ) );
	...
	protected function get_html_load_more() {
		...
		foreach ( $states as $state ) {
			...
			$text_setting = $this->widget->get_settings_fallback( "pagination_load_more_text_{$state}" );
