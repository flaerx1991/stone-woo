...
final class Module extends Base_Module {
	...
	public function register_ajax_widget( AjaxWidgetModule $ajax_widget ) {
		$ajax_widget->add_handler( 'cmsmasters-archive-posts', array( $this, 'render_ajax_widget' ) );
		$ajax_widget->add_handler( 'cmsmasters-blog-featured', array( $this, 'render_ajax_widget' ) );
		$ajax_widget->add_handler( 'cmsmasters-blog-grid', array( $this, 'render_ajax_widget' ) );
		$ajax_widget->add_handler( 'cmsmasters-theme-blog-grid', array( $this, 'render_theme_ajax_widget' ) );
	}
	 ...
	 * @return string
	 */
	public function render_theme_ajax_widget( $ajax_vars, Theme_Base_Blog_Elements $widget ) {
		/* Render Posts */
		ob_start();
