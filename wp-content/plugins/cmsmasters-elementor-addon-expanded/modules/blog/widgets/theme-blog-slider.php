 ...
 * @since 1.0.0
 */
class Theme_Blog_Slider extends Theme_Base_Blog_Customizable {
	...
	public function get_title() {
		return __( 'Theme Posts Slider', 'cmsmasters-elementor' );
	}
	 ...
	 * @since 1.0.0
	 */
	public function render_post_inner( $popup = false ) {
		parent::render_post_inner( false );
	}
	...
	protected function render_posts_inner() {
		...
		if ( 'product' === $settings['blog_post_type'] ) {
			foreach ( $this->posts_popup_id as $post_id ) {
				// var_dump( $this->posts_popup_id );
