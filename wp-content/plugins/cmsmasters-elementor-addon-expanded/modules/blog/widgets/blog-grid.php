...
class Blog_Grid extends Base_Blog_Customizable {
	...
	protected function injection_section_content_layout() {
		...
		// $masonry = $this->get_controls( 'masonry' );

		// $this->add_control(
		// 	'masonry_hidden',
		// 	array(
		// 		'type' => Controls_Manager::HIDDEN,
		// 		'default' => $masonry['return_value'],
		// 		'prefix_class' => $masonry['prefix_class'],
		// 		'render_type' => 'ui',
		// 		'selectors' => array(
	...
	public function get_icon_post() {
		...
		Icons_Manager::render_icon( $settings['global_icon'] );
	}
