...
class Module extends Base_Module {
	...
	protected function init_actions() {
		$this->effect_types = array(
			...
			'tilt' => __( 'Mouse Track', 'cmsmasters-elementor' ),
	...
	private function register_background_controls() {
		...
		$injection_start_control = 'background_bg_width';

		if ( ! Plugin::elementor()->experiments->is_feature_active( 'additional_custom_breakpoints' ) ) {
			$injection_start_control .= '_mobile';
		}

		$this->parent->start_injection( array( 'of' => $injection_start_control ) );
