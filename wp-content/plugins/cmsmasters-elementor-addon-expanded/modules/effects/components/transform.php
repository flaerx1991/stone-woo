...
class Transform extends Component_Base {
	...
	public function register_effect_controls() {
		...
		$in_control_selectors = sprintf(
			'%1$s: 0px; %2$s: 0px; %3$s: 0deg; %4$s: 0deg; %5$s: 0deg; %6$s: 1; %7$s: 1; %8$s: 0deg; %9$s: 0deg; %10$s: 1;',
		...
		$column_inner_selector = '.elementor-element.elementor-element-{{ID}} > .elementor-widget-container';
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					".elementor-section:hover > .elementor-container > .elementor-column.cmsmasters-effect-type-transform > .elementor-widget-wrap, " .
