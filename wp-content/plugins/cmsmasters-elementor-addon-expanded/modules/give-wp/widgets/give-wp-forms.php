...
class Give_WP_Forms extends Give_WP_Base {
	...
	public function get_title() {
		return __( 'GiveWP Forms', 'cmsmasters-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'warning_form',
			array(
				'raw' => '<strong>' . $this->get_title() . '</strong>' . __( ' The settings only work for the "Legacy Form Template". ', 'cmsmasters-elementor' ) . '<a href="' . $this->get_url( 'give_forms&page=give-forms' ) . '" target="_blank">' . __( 'Go to the form creation page', 'cmsmasters-elementor' ) . '</a>',
