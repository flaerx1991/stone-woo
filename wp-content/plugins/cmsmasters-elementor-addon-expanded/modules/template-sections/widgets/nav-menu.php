...
class Nav_Menu extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}.cmsmasters-dropdown-absolute-yes .elementor-widget-container ' . $widget_selector . '__dropdown' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}:not(.cmsmasters-dropdown-absolute-yes) .elementor-widget-container' => 'width: {{SIZE}}{{UNIT}};',
				),
				'conditions' => array(
					'relation' => 'or',
					'terms' => array(
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_bg_color', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_top_distance', '{{SIZE}}{{UNIT}}' ),
				),
				'conditions' => array(
					'relation' => 'or',
					'terms' => array(
		...
		$this->add_control(
			...
			array(
				...
				'frontend_available' => true,
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_horizontal_distance', '{{SIZE}}{{UNIT}}' ),
				),
				'conditions' => array(
					'relation' => 'or',
					'terms' => array(
				...
				'fields_options' => array(
					'border' => array(
						...
						'selectors' => array(
							...
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_border_style', '{{VALUE}}' ),
						),
					),
					'width' => array(
						'label' => _x( 'Border Width', 'Border Control', 'cmsmasters-elementor' ),
					...
					'color' => array(
						...
						'selectors' => array(
							...
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_border_color', '{{VALUE}}' ),
						),
						'condition' => array(
							'border!' => array(
								'',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_border_radius', '{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_sublevel_gap_top', '{{TOP}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'dropdown_sublevel_gap_right', '{{RIGHT}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'dropdown_sublevel_gap_bottom', '{{BOTTOM}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'dropdown_sublevel_gap_left', '{{LEFT}}{{UNIT}}' ),
				),
			)
		);
				...
				'fields_options' => array(
					'font_family' => array(
						'selectors' => array(
							...
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_font_family', '"{{VALUE}}"' ),
						),
					),
					'font_size' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_font_size', '{{SIZE}}{{UNIT}}' ),
						),
					),
					'font_weight' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'font-weight: {{VALUE}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_font_weight', '{{VALUE}}' ),
						),
					),
					'text_transform' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'text-transform: {{VALUE}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_text_transform', '{{VALUE}}' ),
						),
					),
					'font_style' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'font-style: {{VALUE}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_font_style', '{{VALUE}}' ),
						),
					),
					'text_decoration' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'text-decoration: {{VALUE}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_text_decoration', '{{VALUE}}' ),
						),
					),
					'line_height' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'line-height: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_line_height', '{{SIZE}}{{UNIT}}' ),
						),
					),
					'letter_spacing' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'letter-spacing: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_letter_spacing', '{{SIZE}}{{UNIT}}' ),
						),
					),
					'word_spacing' => array(
						'selectors' => array(
							'{{SELECTOR}}' => 'word-spacing: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_typography_word_spacing', '{{SIZE}}{{UNIT}}' ),
						),
					),
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_color', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_bg', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_color', '{{VALUE}}' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_color_hover', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_bg_hover', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_color_hover', '{{VALUE}}' ),
				),
				'condition' => array( 'dropdown_main_level_border_border!' => 'none' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_color_active', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_bg_active', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_color_active', '{{VALUE}}' ),
				),
				'condition' => array( 'dropdown_main_level_border_border!' => 'none' ),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_item_main_vertical_padding', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_item_space_main_between', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
				...
				'fields_options' => array(
					'border' => array(
						...
						'selectors' => array(
							...
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_style', '{{VALUE}}' ),
						),
					),
					'width' => array(
						'label' => _x( 'Border Width', 'Border Control', 'cmsmasters-elementor' ),
						'selectors' => array(
							...
							'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_width_top', '{{TOP}}{{UNIT}}' ) .
							Utils::prepare_css_var( 'dropdown_main_level_border_width_right', '{{RIGHT}}{{UNIT}}' ) .
							Utils::prepare_css_var( 'dropdown_main_level_border_width_bottom', '{{BOTTOM}}{{UNIT}}' ) .
							Utils::prepare_css_var( 'dropdown_main_level_border_width_left', '{{LEFT}}{{UNIT}}' ),
						),
						'condition' => array(
							'border!' => array(
								'',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_main_level_border_radius', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$dropdown_sublevel_links = '{{WRAPPER}} ' . $widget_selector . '__main.cmsmasters-layout-horizontal > ul > li > ' . $widget_selector . '__dropdown-submenu ul a,
			...
			{{WRAPPER}} ' . $widget_selector . '__main.cmsmasters-layout-vertical.cmsmasters-vertical-type-toggle > ul ' . $widget_selector . '__dropdown-submenu a,
		...
		$dropdown_sublevel_links_hover = '{{WRAPPER}} ' . $widget_selector . '__main.cmsmasters-layout-horizontal > ul > li > ' . $widget_selector . '__dropdown-submenu ul a:hover,
			...
			{{WRAPPER}} ' . $widget_selector . '__main.cmsmasters-layout-vertical.cmsmasters-vertical-type-toggle > ul ' . $widget_selector . '__dropdown-submenu a:hover,
			{{WRAPPER}} ' . $widget_selector . '__main.cmsmasters-layout-vertical.cmsmasters-vertical-type-toggle > ul ' . $widget_selector . '__dropdown-submenu a:focus,
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_divider_type', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_divider_size', '{{SIZE}}{{UNIT}}' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}' => Utils::prepare_css_var( 'dropdown_divider_color', '{{VALUE}}' ),
				),
				'condition' => array( 'dropdown_divider_type!' => 'none' ),
			)
		);
		...
		AnimationModule::register_sections_controls( $this, true, $conditions );
	}
	...
	protected function megamenu_content_controls_section() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_max_width', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_text_alignment', '{{VALUE}}' ),
				),
			)
		);
	...
	protected function megamenu_container_style_controls_section() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_container_top_gap', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_container_horizontal_gap', '{{SIZE}}{{UNIT}}' ),
				),
				'condition' => array(
					'layout' => 'vertical',
					'vertical_menu_type' => 'normal',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_container_bd_radius', '{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_container_padding_top', '{{TOP}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_container_padding_right', '{{RIGHT}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_container_padding_bottom', '{{BOTTOM}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_container_padding_left', '{{LEFT}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_padding_top', '{{TOP}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_column_padding_right', '{{RIGHT}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_column_padding_bottom', '{{BOTTOM}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_column_padding_left', '{{LEFT}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_gap', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_divider_style', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_divider_width', '{{SIZE}}{{UNIT}}' ),
				),
				'condition' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_divider_height', '{{SIZE}}{{UNIT}}' ),
				),
				'condition' => array(
					'megamenu_column_divider_style!' => array( '', 'none' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_column_divider_color', '{{VALUE}}' ),
				),
				'condition' => array(
					'megamenu_column_divider_style!' => array( '', 'none' ),
				),
	...
	protected function megamenu_item_style_controls_section() {
		...
		foreach ( $megamenu_item_states as $state_key => $state_label ) {
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_{$state_key}_colors_color", '{{VALUE}}' ),
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_{$state_key}_colors_bg", '{{VALUE}}' ),
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_{$state_key}_colors_bd", '{{VALUE}}' ),
					),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_horizontal_padding', '{{SIZE}}{{UNIT}}' ),
				),
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_vertical_padding', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_space_between', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_bd_radius', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_divider_style', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_divider_size', '{{SIZE}}{{UNIT}}' ),
				),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_divider_color', '{{VALUE}}' ),
				),
				'condition' => array(
					'megamenu_item_divider_style!' => array( '', 'none' ),
				),
		...
		foreach ( $megamenu_item_column_title_states as $state_key => $state_label ) {
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_column_title_{$state_key}_colors_color", '{{VALUE}}' ),
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_column_title_{$state_key}_colors_bg", '{{VALUE}}' ),
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}}' => Utils::prepare_css_var( "megamenu_item_column_title_{$state_key}_colors_bd", '{{VALUE}}' ),
					),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'separator' => 'before',
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_padding_top', '{{TOP}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_item_column_title_padding_right', '{{RIGHT}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_item_column_title_padding_bottom', '{{BOTTOM}}{{UNIT}}' ) .
					Utils::prepare_css_var( 'megamenu_item_column_title_padding_left', '{{LEFT}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_space_between', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_bd_radius', '{{SIZE}}{{UNIT}}' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_divider_style', '{{VALUE}}' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_divider_size', '{{SIZE}}{{UNIT}}' ),
				),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}' => Utils::prepare_css_var( 'megamenu_item_column_title_divider_color', '{{VALUE}}' ),
				),
				'condition' => array(
					'megamenu_item_column_title_divider_style!' => array( '', 'none' ),
				),
	...
	protected function render() {
		...
		if ( 'dropdown' !== $layout ) {
			...
			if ( 'vertical' === $layout ) {
				$this->add_render_attribute( 'main-menu', 'class', 'cmsmasters-vertical-type-' . $vertical_menu_type );
	...
	public function change_menu_item_css_classes( $args, $item, $depth ) {
		...
		if (
			...
			$args->link_after = '<span class="' . AnimationModule::get_animation_class() . '"></span>';
		}
	...
	public function added_span_in_link( $item, $depth ) {
		...
		if (
			...
			$new_title .= ' ' . AnimationModule::get_animation_class();
		}
		...
		if (
			...
			$new_title .= '<span class="' . $this->get_widget_class() . '__arrow">' .
				Utils::get_render_icon( ( 0 === $depth ) ? $indicator_main : $indicator_submenu ) .
			'</span>';
		}
		...
		if (
			...
			$new_title .= '<span class="' . $this->get_widget_class() . '__arrow">' .
				Utils::get_render_icon( $indicator_submenu ) .
			'</span>';
		}
		...
		if ( 'template' === $item->cmsmasters_megamenu['type'] ) {
			...
			$item_output .= '<div class="' . $this->get_widget_class() . '__megamenu-template-container cmsmasters-megamenu-container">
				<div class="' . $this->get_widget_class() . '__megamenu-template-container-inner">' .
					Elementor_Plugin::$instance->frontend->get_builder_content_for_display( $item->cmsmasters_megamenu['template'] ) .
				'</div>
			</div>';
		}
	...
	public function get_toggle() {
		...
		$this->add_render_attribute( 'toggle-container', 'class', array(
			...
			'cmsmasters-layout-' . $settings['layout'],
			'cmsmasters-menu-dropdown-type-' . $settings['dropdown_menu_type'],
		) );

		echo '<div ' . $this->get_render_attribute_string( 'toggle-container' ) . '>' .
			'<div class="' . $this->get_widget_class() . '__toggle cmsmasters-icon-align-' . $settings['dropdown_toggle_icon_align'] . '">';
	...
	public function get_dropdown_nav() {
		...
		$this->add_render_attribute( 'dropdown-menu', 'class', array(
			...
			$this->get_widget_class() . '__container',
			'cmsmasters-layout-' . $layout,
			'cmsmasters-menu-dropdown-type-' . $dropdown_menu_type,
		) );

		$indicator_submenu_animation = $settings['indicator_submenu_animation'];

		if ( 'none' !== $indicator_submenu_animation ) {
			$this->add_render_attribute( 'dropdown-menu', 'class', 'cmsmasters-arrow-animation-' . $indicator_submenu_animation );
		}

		if ( 'vertical' === $layout ) {
			$this->add_render_attribute( 'dropdown-menu', 'class', 'cmsmasters-vertical-type-' . $settings['vertical_menu_type'] );
		}
