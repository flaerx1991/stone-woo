...
class Fancy_Text extends Base_Widget {
	...
	public function get_script_depends() {
		return array( 'typed', 'vticker', 'morphext' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'groups' => array(
					array(
						'label' => __( 'Primary', 'cmsmasters-elementor' ),
						'options' => array(
							'typing' => __( 'Typing', 'cmsmasters-elementor' ),
							'slide' => __( 'SlideUp', 'cmsmasters-elementor' ),
						),
					),
					array(
						...
						'options' => array(
							...
							'bounceIn' => __( 'BounceIn', 'cmsmasters-elementor' ),
							'bounceInUp' => __( 'BounceInUp', 'cmsmasters-elementor' ),
							'bounceInRight' => __( 'BounceInRight', 'cmsmasters-elementor' ),
							'bounceInDown' => __( 'BounceInDown', 'cmsmasters-elementor' ),
							'bounceInLeft' => __( 'BounceInLeft', 'cmsmasters-elementor' ),
						),
					),
					array(
						'label' => __( 'Fade In', 'cmsmasters-elementor' ),
						'options' => array(
							'fadeIn' => __( 'fadeIn', 'cmsmasters-elementor' ),
							'fadeInDown' => __( 'fadeInDown', 'cmsmasters-elementor' ),
							'fadeInLeft' => __( 'fadeInLeft', 'cmsmasters-elementor' ),
							'fadeInRight' => __( 'fadeInRight', 'cmsmasters-elementor' ),
							'fadeInUp' => __( 'fadeInUp', 'cmsmasters-elementor' ),
						),
					),
					array(
						...
						'options' => array(
							...
							'flipInX' => __( 'flipInX', 'cmsmasters-elementor' ),
							'flipInY' => __( 'flipInY', 'cmsmasters-elementor' ),
						),
					),
					array(
						'label' => __( 'Rotate In', 'cmsmasters-elementor' ),
						'options' => array(
							'rotateIn' => __( 'rotateIn', 'cmsmasters-elementor' ),
							'rotateInDownLeft' => __( 'rotateInDownLeft', 'cmsmasters-elementor' ),
							'rotateInDownRight' => __( 'rotateInDownRight', 'cmsmasters-elementor' ),
							'rotateInUpLeft' => __( 'rotateInUpLeft', 'cmsmasters-elementor' ),
							'rotateInUpRight' => __( 'rotateInUpRight', 'cmsmasters-elementor' ),
						),
					),
					array(
						'label' => __( 'Rotate In', 'cmsmasters-elementor' ),
						'options' => array(
							'zoomIn' => __( 'zoomIn', 'cmsmasters-elementor' ),
							'zoomInDown' => __( 'zoomInDown', 'cmsmasters-elementor' ),
							'zoomInLeft' => __( 'zoomInLeft', 'cmsmasters-elementor' ),
							'zoomInRight' => __( 'zoomInRight', 'cmsmasters-elementor' ),
							'zoomInUp' => __( 'zoomInUp', 'cmsmasters-elementor' ),
						),
					),
					array(
						'label' => __( 'Other', 'cmsmasters-elementor' ),
						'options' => array(
							'flash' => __( 'Flash', 'cmsmasters-elementor' ),
							'pulse' => __( 'Pulse', 'cmsmasters-elementor' ),
							'rubberBand' => __( 'RubberBand', 'cmsmasters-elementor' ),
							'shake' => __( 'Shake', 'cmsmasters-elementor' ),
							'swing' => __( 'Swing', 'cmsmasters-elementor' ),
							'tada' => __( 'Tada', 'cmsmasters-elementor' ),
							'wobble' => __( 'Wobble', 'cmsmasters-elementor' ),
							'lightSpeedIn' => __( 'lightSpeedIn', 'cmsmasters-elementor' ),
	...
	protected function render() {
		...
		if ( ! empty( $settings['before_text_content'] ) ) {
			echo '<span class="elementor-widget-cmsmasters-fancy-text__before-text">
				<span ' . $this->get_render_attribute_string( 'prefix' ) . '>' . $settings['before_text_content'] . '</span>
			</span>';
		}
		...
		if ( 'typing' === $settings['animation_effect'] ) {
			...
			echo '<span class="elementor-widget-cmsmasters-fancy-text__fancy-text">
				<span class="elementor-widget-cmsmasters-fancy-text__list-items">';
			...
			foreach ( $settings['fancy_text_list'] as $index => $item ) {
				...
				if ( ! empty( $item['item_text'] ) ) {
					echo '<li ' . $this->get_render_attribute_string( $repeater_item_setting_key ) . '>' . $item['item_text'] . '</li>';
				}
			}
			...
			foreach ( $settings['fancy_text_list'] as $index => $item ) {
				...
				$strings_list .= '<span ' . $this->get_render_attribute_string( $repeater_item_setting_key ) . '>' . $item['item_text'] . '</span>, ';
			}

			echo '<span class="elementor-widget-cmsmasters-fancy-text__fancy-text fancy-text-hidden">' . rtrim( $strings_list, ', ' ) . '</span>';
		}

		if ( ! empty( $settings['after_text_content'] ) ) {
			echo '<span class="elementor-widget-cmsmasters-fancy-text__after-text">
				<span ' . $this->get_render_attribute_string( 'suffix' ) . '>' . $settings['after_text_content'] . '</span>
			</span>';
		}
			...
			<div class="elementor-widget-cmsmasters-fancy-text__fancy-text">
				<span class="elementor-widget-cmsmasters-fancy-text__list-items">
					<# _.each ( settings.fancy_text_list, ( item, index ) => {
						...
						if ( '' !== item.item_text ) #>
							<span {{{ view.getRenderAttributeString( repeaterItem ) }}}>{{{ item.item_text }}}</span>
					<# } ); #>
				</span>
			</div>
		<# } else {
