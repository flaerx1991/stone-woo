...
class Animated_Text extends Base_Widget {
	...
	protected function animated_elements_multiple() {
		...
		foreach ( $settings['animated_text_list'] as $item ) {
			if ( ! empty( $item['item_text'] ) ) {
				echo '<span class="elementor-widget-cmsmasters-fancy-text__list-item">' . $item['item_text'] . '</span>';
			}
		}
	...
	protected function animated_elements_single() {
		...
		echo '<span class="elementor-widget-cmsmasters-animated-text__animated-text-single elementor-widget-cmsmasters-animated-text__effect ' . $settings['animation_effect'] . '">
			<span>' . $string . '</span>
		</span>';
	}
