...
final class Module extends Base_Module {
	...
	public function register_ajax_widget( AjaxWidgetModule $ajax_widget ) {
		$ajax_widget->add_handler( 'cmsmasters-social-counter', array( $this, 'get_ajax_social_counter' ) );
	}
	...
	public function register_admin_fields( Settings_Page $settings ) {
		$settings->add_section( 'cmsmasters', 'behance', array(
			'callback' => function() {
				echo '<h2>' . esc_html__( 'Behance', 'cmsmasters-elementor' ) . '</h2>';
			},
			'fields' => array(
				'behance_url' => array(
		...
		$settings->add_section( 'cmsmasters', 'twitter', array(
			'callback' => function() {
				echo '<br><hr><br><h2>' . esc_html__( 'Twitter', 'cmsmasters-elementor' ) . '</h2>';
			},
			'fields' => array(
				...
				'twitter_connector' => array(
					'field_args' => array(
						...
						'html' => sprintf(
							...
							esc_html__( 'Connect an Twitter Account', 'cmsmasters-elementor' )
						),
					),
				),
			),
