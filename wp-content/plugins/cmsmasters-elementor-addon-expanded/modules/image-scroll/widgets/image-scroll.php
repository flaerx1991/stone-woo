	...
	protected function render() {
		...
		if ( 'none' !== $settings['icon_label'] ) {
			...
			if ( 'text' === $settings['icon_label'] ) {
				echo '<span class="elementor-widget-cmsmasters-image-scroll__label-text">' . $settings['text'] . '</span>';
			}
		...
		if ( '' !== $settings['caption'] ) {
			echo '<figcaption class="elementor-widget-cmsmasters-image-scroll__caption">' . $settings['caption'] . '</figcaption>';
		}
