...
class Featured_Box extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .elementor-widget-cmsmasters-featured-box__type-wrap *' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .elementor-widget-cmsmasters-featured-box__image-wrap' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .elementor-widget-cmsmasters-featured-box__graphic-wrapper .elementor-widget-cmsmasters-featured-box__title' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'device_args' => Breakpoints_Manager::get_devices_args( $graphic_position_v_arg ),
			)
		);
		...
		foreach ( $colors as $key => $label ) {
			...
			$this->add_group_control(
				...
				array(
					'name' => "button_bg_{$key}",
					'exclude' => array( 'color' ),
					'selector' => "{{WRAPPER}} .elementor-widget-cmsmasters-featured-box__button{$element}",
				)
			);
	...
	protected function render_button() {
		...
		$button_text = ( '' === $settings['button'] ) ? __( 'Click Here', 'cmsmasters-elementor' ) : $settings['button'];
	...
	protected function get_button_icon() {
		...
		if ( isset( $settings['button_icon']['value'] ) && '' !== $settings['button_icon']['value'] ) {
