   ...
   /**
    ...
    protected function render() {
        ...
        if ( 'tabs' === $settings['view'] ) {
            $label_hide = $settings['hide_label'] === 'yes' ? '0' : '1';
        } else {
            $label_hide = '0';
        }
        ...
        $title = $settings['event-title'] === 'yes' ? '1' : '0';
        $time = $settings['timeslot'] === 'yes' ? '1' : '0';
        $subtitle = $settings['event-subtitle'] === 'yes' ? '1' : '0';
        $description = $settings['event-description'] === 'yes' ? '1' : '0';
        $user = $settings['event-user'] === 'yes' ? '1' : '0';
        $hide_label = $label_hide;
        $hide_hrs = $settings['hide_hrs'] === 'yes' ? '0' : '1';
