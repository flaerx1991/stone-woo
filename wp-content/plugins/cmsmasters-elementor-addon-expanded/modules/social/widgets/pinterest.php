...
class Pinterest extends Base_Widget {
	...
	public function get_board_profile_html() {
		...
		$attributes = array(
			...
			'href' => esc_url( $url ),
			'data-pin-do' => $class,
			'data-pin-scale-width' => $settings['image_width']['size'],
			'data-pin-scale-height' => $settings['board_height']['size'],
			'data-pin-board-width' => $settings['board_width']['size'],
		);
