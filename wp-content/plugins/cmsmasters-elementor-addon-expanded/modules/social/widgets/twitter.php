...
class Twitter extends Base_Widget {
	...
	public function get_title() {
		return __( 'Twitter', 'cmsmasters-elementor' );
	}
	...
	public function get_tweet_html( $settings ) {
		$attributes = array(
			...
			'data-lang' => get_locale(),
			'data-partner' => 'twitter-deck',
			'data-cards' => ( $settings['expanded_tweet'] ? $settings['expanded_tweet'] : 'hidden' ),
			'data-theme' => $settings['theme'],
			'data-align' => $settings['alignment_tweet'],
		);
	...
	public function get_moments_html( $settings ) {
		$attributes = array(
			...
			'data-lang' => get_locale(),
			'data-partner' => 'twitter-deck',
			'data-limit' => absint( $settings['limit'] ),
		);
