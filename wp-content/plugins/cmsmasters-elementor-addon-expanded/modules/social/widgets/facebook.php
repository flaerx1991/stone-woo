...
class Facebook extends Base_Widget {
	...
	public function get_page_html( $settings ) {
		$attributes = array(
			...
			'data-tabs' => implode( ',', $settings['tabs_page'] ),
			'data-width' => $settings['width_page']['size'],
			'data-height' => $settings['height_page']['size'],
	...
	public function get_post_html( $settings ) {
		$attributes = array(
			...
			'data-width' => $settings['width_post']['size'],
		);
	...
	public function get_comments_html( $settings ) {
		$attributes = array(
			...
			'data-width' => $settings['width_comments']['size'],
