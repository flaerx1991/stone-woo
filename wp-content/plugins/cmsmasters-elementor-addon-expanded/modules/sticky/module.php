			...
			$this->parent->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}}.headroom--not-top.elementor-section-boxed > .elementor-container' => 'max-width: {{SIZE}}{{UNIT}};',
					),
					'condition' => array(
						'layout' => array( 'boxed' ),
						self::get_control_full_name( 'type!' ) => 'default',
			...
			$this->parent->add_responsive_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}}.headroom--not-top.elementor-section-height-min-height > .elementor-container' => 'min-height: {{SIZE}}{{UNIT}};',
					),
					'condition' => array(
