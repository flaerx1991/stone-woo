...
class ShareButtons extends _social.default {
  ...
  bindEvents() {
    ...
    this.elements.$link.not(`${selectors.pinterest}, ${selectors.email}, ${selectors.print}`).on('click', this.openNewWindow.bind(this));
...
//# sourceMappingURL=share-buttons.d28c87859ca50f43258d.bundle.js.map