...
class ProductImagesSlider extends _productImagesBase.default {
  ...
  bindEvents() {
    ...
    this.elements.$thumbItems.on('click', this.showSlide.bind(this));
    this.elements.$zoomImages.on('hover', this.insertZoom.bind(this));
    this.getVariationState();
    this.elements.$thumbItems.on('click', this.initZoom.bind(this));
  }
  onInit() {
    super.onInit();
    this.slider.init();
...
//# sourceMappingURL=product-images-slider.7ee12d8dfa33363aa43d.bundle.js.map