...
class Gallery extends _handler.default {
  ...
  getGallerySettings() {
    ...
    const gallerySettings = {
      ...
      verticalGap: this.getDeviceSetting('gap').size,
    ...
    gallerySettings.breakpoints[frontendBreakpoints.lg - 1] = {
      ...
      verticalGap: this.getDeviceSetting('gap', 'tablet').size,
    ...
    gallerySettings.breakpoints[frontendBreakpoints.md - 1] = {
      ...
      verticalGap: this.getDeviceSetting('gap', 'mobile').size,
...
//# sourceMappingURL=gallery.dd3d0c6e12e94cd8f3a5.bundle.js.map