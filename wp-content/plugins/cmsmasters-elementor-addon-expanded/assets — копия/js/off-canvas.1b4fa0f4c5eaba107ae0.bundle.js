...
class OffCanvas extends _handler.default {
  ...
  bindEvents() {
    this.elements.$triggerButton.on('click', this.offcanvasContent.bind(this));
    this.elements.$closeButton.on('click', this.offcanvasClose.bind(this));
    this.elements.$menuParent.on('click', this.onParentClick.bind(this));
    this.elements.$containerOverlay.on('click', this.containerClick.bind(this));
  ...
  onParentClick(event) {
    ...
    const $menuArrow = $clickedItem.hasClass(classes.menuArrow) ? $clickedItem : $clickedItem.closest('.elementor-widget-cmsmasters-offcanvas__arrow');
...
//# sourceMappingURL=off-canvas.1b4fa0f4c5eaba107ae0.bundle.js.map