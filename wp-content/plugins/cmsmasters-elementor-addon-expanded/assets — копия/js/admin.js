...
/***/ "../modules/settings/assets/dev/js/admin/admin.js":
/*!********************************************************!*\
  !*** ../modules/settings/assets/dev/js/admin/admin.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "../node_modules/@babel/runtime/helpers/classCallCheck.js"));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "../node_modules/@babel/runtime/helpers/createClass.js"));
var _apiValidation = _interopRequireDefault(__webpack_require__(/*! ./api-validation */ "../modules/settings/assets/dev/js/admin/api-validation.js"));
var _default = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(_default, [{
    key: "init",
    value: function init() {
      this.api.instagram = new _apiValidation.default('cmsmasters_instagram_user_id', {
        token: 'cmsmasters_instagram_access_token',
        type: 'instagram_account_type'
      });
    }
  }]);
  return _default;
...
/***/ "../modules/settings/assets/dev/js/admin/api-validation.js":
/*!*****************************************************************!*\
  !*** ../modules/settings/assets/dev/js/admin/api-validation.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "../node_modules/@babel/runtime/helpers/classCallCheck.js"));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "../node_modules/@babel/runtime/helpers/createClass.js"));
var ApiValidation = /*#__PURE__*/function () {
  function ApiValidation(key) {
    var fields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    (0, _classCallCheck2.default)(this, ApiValidation);
    this.key = key;
    this.token = fields.token ? fields.token : false;
    this.type = fields.type ? fields.type : false;
    this.url = fields.url ? fields.url : false;
    this.elements = {};
    this.stateClasses = ['loading', 'success', 'error'];
    this.init();
  }
  (0, _createClass2.default)(ApiValidation, [{
    key: "init",
    value: function init() {
      this.setElements();
      this.bindEvents();
    ...
    value: function setElements() {
      this.elements = {
        $button: jQuery("#elementor_".concat(this.key, "_button")),
        $apiKeyField: jQuery("#elementor_".concat(this.key))
      };
      if (this.token) {
        this.elements.$apiTokenField = jQuery("#elementor_".concat(this.token));
      }
      if (this.type) {
        this.elements.$apiTypeField = jQuery("select[name='elementor_".concat(this.type, "']"));
      }
      if (this.url) {
        this.elements.$apiUrlField = jQuery("#elementor_".concat(this.url));
      }
    }
  }, {
    key: "bindEvents",
    value: function bindEvents() {
      ...
      var _this$elements = this.elements,
        ...
        $apiKeyField = _this$elements.$apiKeyField;
      ...
      if (this.token) {
        this.elements.$apiTokenField.on('change', function () {
          return _this.setState();
        });
      }
      if (this.type) {
        this.elements.$apiTypeField.on('change', function () {
          return _this.setState();
        });
      }
      if (this.url) {
        this.elements.$apiUrlField.on('change', function () {
          return _this.setState();
        });
      }
    }
    ...
    value: function validateApi() {
      ...
      var _this$elements2 = this.elements,
        $button = _this$elements2.$button,
        $apiKeyField = _this$elements2.$apiKeyField;
      if (this.token) {
        if ('' === this.elements.$apiTokenField.val()) {
          this.setState();
          return;
        }
      } else if ('' === $apiKeyField.val() || this.url && '' === this.elements.$apiUrlField.val()) {
        this.setState();
        return;
      }
      var requestData = {
      ...
      if (this.token && '' !== this.elements.$apiTokenField.val()) {
        requestData.api_token = this.elements.$apiTokenField.val();
        if (this.type) {
          requestData.user_type = this.elements.$apiTypeField.val();
        }
      } else {
        requestData.api_key = $apiKeyField.val();
        if (this.url && '' !== this.elements.$apiUrlField.val()) {
          requestData.api_url = this.elements.$apiUrlField.val();
        }
      }
      jQuery.post(ajaxurl, requestData).done(function (data) {
        if (_this2.token) {
          _this2.elements.$apiKeyField.val(data.data);
        }
        var state = data.success ? 'success' : 'error';
    ...
    value: function setState(type) {
      ...
      for (var classIndex in this.stateClasses) {
        var currentClass = this.stateClasses[classIndex];
...
var _admin6 = _interopRequireDefault(__webpack_require__(/*! cmsmasters-modules/settings/assets/dev/js/admin/admin */ "../modules/settings/assets/dev/js/admin/admin.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
