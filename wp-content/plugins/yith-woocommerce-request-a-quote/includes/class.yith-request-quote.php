		...
		public function send_message() {
			...
			if ( ! isset( $_POST['rqa_name'] ) ) {
				...
				if ( empty( $errors ) ) {
					...
					$project_location = isset( $_POST['project_location'] ) ? sanitize_text_field( wp_unslash( $_POST['project_location'] ) ) : '';
					$project_timeline = isset( $_POST['project_timeline'] ) ? sanitize_text_field( wp_unslash( $_POST['project_timeline'] ) ) : '';
					$user_phone = isset( $_POST['rqa_phone'] ) ? sanitize_text_field( wp_unslash( $_POST['rqa_phone'] ) ) : '';
