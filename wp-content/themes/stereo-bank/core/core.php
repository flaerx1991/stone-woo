<?php
namespace StereoBankSpace\Core;

use StereoBankSpace\Admin\Admin;
use StereoBankSpace\Core\Traits\Singleton;
use StereoBankSpace\Core\Utils\File_Manager;
use StereoBankSpace\Core\Utils\Utils;
use StereoBankSpace\Kits\Module as Kits;
use StereoBankSpace\Modules\Modules;
...
use StereoBankSpace\ThemeConfig\Theme_Plugins;
...
class Core {
	...
	public function get_responsive_stylesheet_templates( $templates ) {
		...
		foreach ( $templates_paths as $template_path ) {
			$file_name = 'stereo-bank-' . basename( $template_path );
	...
	public function enqueue_frontend_assets() {
		...
		wp_localize_script( 'stereo-bank-frontend', 'cmsmasters_localize_vars', array(
	...
	public function register_widget_areas() {
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Sidebar', 'stereo-bank' ),
				'id' => 'sidebar_default',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars.', 'stereo-bank' ),
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Archive Sidebar', 'stereo-bank' ),
				'id' => 'sidebar_archive',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Search Sidebar', 'stereo-bank' ),
				'id' => 'sidebar_search',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 1', 'stereo-bank' ),
				'id' => 'footer-1',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 2', 'stereo-bank' ),
				'id' => 'footer-2',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 3', 'stereo-bank' ),
				'id' => 'footer-3',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 4', 'stereo-bank' ),
				'id' => 'footer-4',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 5', 'stereo-bank' ),
				'id' => 'footer-5',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'stereo-bank' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
	...
	public function register_translations() {
		load_theme_textdomain( 'stereo-bank', get_template_directory() . '/theme-config/languages' );
	}
	...
	public function register_nav_menu_locations() {
		register_nav_menus(
			array(
				'header_top_nav' => esc_html__( 'Header Top Navigation', 'stereo-bank' ),
				'header_mid_nav' => esc_html__( 'Header Middle Navigation', 'stereo-bank' ),
				'header_bot_nav' => esc_html__( 'Header Bottom Navigation', 'stereo-bank' ),
				'footer_nav' => esc_html__( 'Footer Navigation', 'stereo-bank' ),
			)
		);
	}
	...
	public function filter_password_form() {
		$output = '<p>' . esc_html__( 'This content is password protected. To view it please enter your password below:', 'stereo-bank' ) . '</p>' .
		'<form action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form cmsmasters-post-password-form" method="post">' .
			'<input name="post_password" type="password" size="20" placeholder="' . esc_attr__( 'Password', 'stereo-bank' ) . '" />' .
			'<input type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form', 'stereo-bank' ) . '" />' .
		'</form>';
