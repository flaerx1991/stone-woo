...
class Table extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'stereo-bank' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default table, Gutenberg editor.', 'stereo-bank' ),
		...
		$parts = array(
			'tbody' => '',
			'thead' => esc_html__( 'Header', 'stereo-bank' ),
			'tfoot' => esc_html__( 'Footer', 'stereo-bank' ),
		);
