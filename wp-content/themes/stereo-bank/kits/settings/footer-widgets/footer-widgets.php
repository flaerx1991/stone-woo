<?php
namespace StereoBankSpace\Kits\Settings\FooterWidgets;
...
class Footer_Widgets extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widgets', 'stereo-bank' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'show' => esc_html__( 'Show On All Devices', 'stereo-bank' ),
					'hide_tablet' => esc_html__( 'Hide On Tablet And Less', 'stereo-bank' ),
					'hide_mobile' => esc_html__( 'Hide On Mobile', 'stereo-bank' ),
					'hide' => esc_html__( 'Hide On All Devices', 'stereo-bank' ),
				),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Desktop', 'stereo-bank' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label_block' => true,
				'show_label' => false,
				'raw' => esc_html__( 'Layout for this columns count will be', 'stereo-bank' ) . '<br />1/5 + 1/5 + 1/5 + 1/5 + 1/5',
				'type' => Controls_Manager::RAW_HTML,
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Tablet', 'stereo-bank' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Columns in Row', 'stereo-bank' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Reverse Columns', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'tablet_hide_1',
			array(
				'label' => esc_html__( 'Hide "Footer 1" widgets area', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
		...
		$this->add_control(
			'tablet_hide_2',
			array(
				'label' => esc_html__( 'Hide "Footer 2" widgets area', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
		...
		$this->add_control(
			'tablet_hide_3',
			array(
				'label' => esc_html__( 'Hide "Footer 3" widgets area', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
		...
		$this->add_control(
			'tablet_hide_4',
			array(
				'label' => esc_html__( 'Hide "Footer 4" widgets area', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
		...
		$this->add_control(
			'tablet_hide_5',
			array(
				'label' => esc_html__( 'Hide "Footer 5" widgets area', 'stereo-bank' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'stereo-bank' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'stereo-bank' ),
				'label_on' => esc_html__( 'Yes', 'stereo-bank' ),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Mobile', 'stereo-bank' ),
			)
		);
		...
		$this->add_responsive_control(
			'columns_gap',
			array(
				'label' => esc_html__( 'Columns Gap', 'stereo-bank' ),
		...
		$this->add_responsive_control(
			'widgets_gap',
			array(
				'label' => esc_html__( 'Widgets Gap Between', 'stereo-bank' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
