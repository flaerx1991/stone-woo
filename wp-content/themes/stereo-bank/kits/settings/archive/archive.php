...
class Archive extends Settings_Tab_Base {
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use an 'Archive' template, then the settings will not be applied, if you set the template to 'All Archives', then these settings will be hidden.", 'stereo-bank' ),
