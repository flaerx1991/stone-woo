	...
	protected function controls_group_post_media( $key = '', $args = array() ) {
		...
		if ( $media_size_tabs ) {
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Image', 'stereo-bank' ) )
			);
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Gallery', 'stereo-bank' ) )
			);
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Video', 'stereo-bank' ) )
			);
				...
				array_merge_recursive(
					...
					array(
						...
						'fields_options' => array(
							'size' => array( 'label' => esc_html__( 'Gallery Image Size', 'stereo-bank' ) ),
						),
						'default' => $this->get_default_setting(
							$this->get_control_name_parameter( $key, 'gallery_image_size' ),
							'large'
			...
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Video Height', 'stereo-bank' ),
						'type' => Controls_Manager::SLIDER,
						'range' => array(
							'%' => array(
								'min' => 0,
