	...
	protected function controls_group_quotes( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Cite', 'stereo-bank' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			)
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'flex' => esc_html__( 'Show', 'stereo-bank' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Offset', 'stereo-bank' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Offset', 'stereo-bank' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
