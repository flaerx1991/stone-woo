	...
	protected function controls_group_nav_dropdown_container( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'First Dropdown', 'stereo-bank' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'center' => esc_html__( 'Below Item', 'stereo-bank' ),
						'stretch' => esc_html__( 'Below Header', 'stereo-bank' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Position', 'stereo-bank' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Gap', 'stereo-bank' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Second Dropdown', 'stereo-bank' ),
					'type' => Controls_Manager::HEADING,
				)
			)
		);
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Gap', 'stereo-bank' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
