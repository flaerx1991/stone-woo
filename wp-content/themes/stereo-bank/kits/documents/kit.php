<?php
namespace StereoBankSpace\Kits\Documents;

use StereoBankSpace\Kits\Module as KitsModule;
...
class Kit extends BaseKit {
	...
	public function check_sitewide_location( $templates = array(), $sitewide_location = 'include/general' ) {
		...
		foreach ( $templates as $template_id => $template_args ) {
			if ( in_array( $sitewide_location, $template_args, true ) ) {
				$result = true;
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'stereo-bank' ),
				'design_system' => esc_html__( 'Design System', 'stereo-bank' ),
				'theme_style' => esc_html__( 'Theme Style', 'stereo-bank' ),
				'settings' => esc_html__( 'Settings', 'stereo-bank' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'stereo-bank' ),
			),
		) );
