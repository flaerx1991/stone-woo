<?php
namespace StereoBankSpace\Kits;

use StereoBankSpace\Kits\Classes;
use StereoBankSpace\Kits\Controls\Controls_Manager;
...
class Module extends ElementorBaseModule {
	...
	public function enqueue_scripts() {
		if ( ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_enqueue_script(
				'stereo-bank-elementor-kits-controls',
