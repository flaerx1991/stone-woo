...
<h2 class="woocommerce-MyAccount-content-title"><?php echo esc_html__( 'ACCOUNT DETAILS', 'woocommerce' )?></h2>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_phone" id="account_phone" autocomplete="phone" value="<?php echo esc_attr( $user->user_phone ); ?>" />
	</p>

	<div class="clear" style="margin: 0 0 8px;"></div>
	<fieldset>
